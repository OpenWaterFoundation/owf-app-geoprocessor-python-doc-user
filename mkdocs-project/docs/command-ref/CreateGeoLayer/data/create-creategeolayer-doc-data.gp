# Create user doc data for CreateGeoLayer command
#
# Create the bounding box for Dallas with the WGS84 projection
CreateGeoLayer(GeoLayerID = "dallas_bounds_wgs84", GeometryFormat = "BoundingBox", GeometryInput = "-97.8,32.35,-96.25,33.32", CRS="EPSG:4326")
# Create the bounding box for Dallas with the NAD83 Zone 14N projection
CreateGeoLayer(GeoLayerID = "dallas_bounds_nad83", GeometryFormat = "BoundingBox", GeometryInput = "611903,3580541,757772,3688789", CRS="EPSG:26914")

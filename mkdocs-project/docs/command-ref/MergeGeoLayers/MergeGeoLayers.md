...
* The MergeGeoLayers command uses the QGIS processing algorithm
[`qgis:mergevectorlayers`](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/qgis/vector_general_tools.html#merge-vector-layers). 
